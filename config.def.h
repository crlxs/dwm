...
static const char *browsercmd[] = { "chromium", "--incognito", NULL };
static const char *scrot[] = {"scrot", "-s", NULL }; /*Scrot is a screen capture utility, with -s works similar to windows snipping tool*/
